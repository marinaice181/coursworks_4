from works.utils import user_hh, user_sj, user_choice_both
...
def user_interaction():
    ...
    """
    print('Здравствуйте! Эта программа поможет Вам в поиске вакансий на сайтах: HeadHunter и SuperJob. \n'
